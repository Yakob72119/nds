    ...
    <div className="min-h-screen bg-white py-10 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-gray-900 dark:text-black sm:text-5xl lg:text-6xl">
            Service Packages & Pricing
          </h1>
          <p className="mt-5 max-w-xl mx-auto text-xl text-gray-900 dark:text-gray-300">
